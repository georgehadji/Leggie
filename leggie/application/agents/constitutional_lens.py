                ...
                findings.append(
                    Finding(
                        ...
                        irac=IRAC(
                            ...
                            application=(
                                f"Το Άρθρο {article.id} περιέχει τη φράση '{m.group(0)}'"
                            ),
                            conclusion=(
                ...
                findings.append(
                    Finding(
                        ...
                        irac=IRAC(
                            ...
                            conclusion=(
                                f"Η αναδρομική ισχύς στο Άρθρο {article.id} χρήζει εξέτασης"
                            ),
                        ),
            ...
            if m:
                findings.append(
                    Finding(
                        ...
                        irac=IRAC(
                            issue=(
                                f"Άρθρο {article.id}: Πιθανή επιρροή σε θεμελιώδη δικαιώματα"
                            ),
                            rule=(
