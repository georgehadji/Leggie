...
_GDPR_PATTERNS = [
    re.compile(
        r"(?:προσωπικά\s+δεδομένα|δεδομέν[αων]\s+προσωπικού\s+χαρακτήρα|ΓΚΠΔ|GDPR)",
        re.UNICODE | re.IGNORECASE,
    ),
    re.compile(
        r"(?:επεξεργασί[αας]|υποκείμεν[οου]\s+των\s+δεδομένων|συγκατάθεση)",
        re.UNICODE | re.IGNORECASE,
    ),
]
...
_CROSS_BORDER_PATTERNS = [
    re.compile(
        r"(?:διαβίβαση|διασυνοριακ[ήή]|τρίτη\s+χώρα|εκτός\s+του\s+ΕΟΧ)", re.UNICODE | re.IGNORECASE
    ),
]
