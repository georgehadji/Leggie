...
_GDPR_PATTERNS = [
    re.compile(
        r"(?:προσωπικά\s+δεδομένα|δεδομένα\s+προσωπικού\s+χαρακτήρα|GDPR|ΓΚΠΔ)",
        re.UNICODE | re.IGNORECASE,
    ),
    re.compile(
        r"(?:επεξεργασί[αα]|συγκατάθεση|υπεύθυνο[ςσ]\s+προστασία[ςσ]|DPO)",
        re.UNICODE | re.IGNORECASE,
    ),
    re.compile(
        r"(?:δικαίωμα\s+πρόσβαση[ςσ]|δικαίωμα\s+διαγραφή[ςσ]|δικαίωμα\s+φορητότητα[ςσ])",
        re.UNICODE | re.IGNORECASE,
    ),
]
...
_EU_DIRECTIVE_PATTERNS = [
    re.compile(
        r"(?:εναρμόνισ[ηη]|ενσωμάτωσ[ηη]|μεταφορά)\s+(?:της|του)\s+(?:οδηγί[αας]|κανονισμού|απόφασης)",
        re.UNICODE | re.IGNORECASE,
    ),
    re.compile(
        r"(?:CELEX|οδηγί[αα]\s+\d{4}|κανονισμό[ςσ]\s+ΕΕ|κατ' εξουσιοδότηση)",
        re.UNICODE | re.IGNORECASE,
    ),
]
...
_NOTIFICATION_PATTERNS = [
    re.compile(
        r"(?:κοινοποίησ[ηη]|γνωστοποίησ[ηη]|ενημέρωσ[ηη])\s+(?:της|στην)\s+Επιτροπή",
        re.UNICODE | re.IGNORECASE,
    ),
    re.compile(
        r"(?:SEM|single\s+market|εσωτερική\s+αγορά|συμβατότητα)", re.UNICODE | re.IGNORECASE
    ),
]

_CROSS_BORDER_PATTERNS = [
    re.compile(
        r"(?:διασυνοριακ(?:ή|ό[ςσ])|διαβίβασ[ηη]|τρίτη\s+χώρα|εκτός\s+ΕΕ)",
        re.UNICODE | re.IGNORECASE,
    ),
    re.compile(
        r"(?:επαρκές\s+επίπεδο|κατάλληλε[ςσ]\s+εγγυήσει[ςσ]|binding\s+corporate)",
        re.UNICODE | re.IGNORECASE,
    ),
]
                ...
                findings.append(
                    Finding(
                        ...
                        irac=IRAC(
                            ...
                            application=(
                                f"Το Άρθρο {article.id} περιέχει αναφορά σε "
                                "προσωπικά δεδομένα/GDPR"
                            ),
                            conclusion=(
                                f"Το Άρθρο {article.id} χρήζει ελέγχου συμβατότητας με GDPR"
                            ),
                        ),
                ...
                findings.append(
                    Finding(
                        ...
                        irac=IRAC(
                            ...
                            rule=(
                                "Οι εθνικές διατάξεις πρέπει να συμμορφώνονται με το "
                                "παράγωγο δίκαιο της ΕΕ"
                            ),
                            application=(
                                f"Το Άρθρο {article.id} αναφέρεται σε εναρμόνιση/ενσωμάτωση "
                                "ενωσιακού δικαίου"
                            ),
                            conclusion=(
                                f"Το Άρθρο {article.id} χρήζει ελέγχου ορθής μεταφοράς "
                                "ενωσιακού δικαίου"
                            ),
                        ),
                        severity=Severity.HIGH,
