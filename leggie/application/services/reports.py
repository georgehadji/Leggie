...
class Report:
    ...
    def to_markdown(self) -> str:
        ...
        # No-legal-advice disclaimer (PROD-27)
        lines.append("")
        lines.append("---")
        lines.append("")
        lines.append(
            "*This report was generated by Leggie, an automated legal-analysis tool. "
            "It is not legal advice and should not be relied upon as such. Consult a "
            "qualified legal professional before acting on any finding.*"
        )
