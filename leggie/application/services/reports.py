        ...
        sections.append(
            {
                ...
                "title": "Overview",
                "content": (
                    f"This report analyzes **{document.title}** "
                    f"({len(document.articles)} articles, {len(findings)} findings). "
                    f"The analysis identified {high_severity_count} high-severity issues."
                ),
            }
        )
