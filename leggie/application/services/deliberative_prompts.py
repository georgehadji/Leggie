...
PERSPECTIVES: dict[str, dict[str, str]] = {
    ...
    "niki": {
        "label": "Συντηρητικό-πατριωτικό κόμμα αντιπολίτευσης (ΝΙΚΗ)",
        "instruction": (
            "Αξιολόγησε το σχέδιο νόμου από τη σκοπιά ενός συντηρητικού-πατριωτικού κόμματος "
            "της αντιπολίτευσης. Η κριτική να είναι τεκμηριωμένη, σοβαρή και όχι λαϊκίστικη· "
            "να δίνει έμφαση στην εθνική κυριαρχία, στην προστασία θεσμών και παραδοσιακών "
            "αξιών, στη δημοσιονομική υπευθυνότητα και στα δικαιώματα των πολιτών έναντι της "
            "κρατικής εξουσίας. Κλείσε με συνολικό συμπέρασμα για τη στάση που θα μπορούσε να "
            "τηρήσει το ελληνικό συντηρητικό πατριωτικό κόμμα ΝΙΚΗ κατά τη συζήτηση του "
            "νομοσχεδίου."
        ),
    },
}
