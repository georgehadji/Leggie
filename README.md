...
[![Tests](https://img.shields.io/badge/tests-757%20passed-brightgreen)](https://github.com/)
...
### Testing
- **757 unit and integration tests**, 100% passing
- 62 test files covering domain, application, and infrastructure layers
- Suite is **hermetic**: zero outbound connections (socket guard asserted in CI)
- Line coverage 82.7%, floor 80%
